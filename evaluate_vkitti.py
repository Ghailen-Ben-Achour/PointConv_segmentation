...
TEST_DATASET_WHOLE_SCENE = scannet_dataset_rgb.ScannetDataset(root=root, block_points=NUM_POINT, split='val')
...
def eval_epoch(sess, ops):
    ...
    for batch_idx in range(num_batches):
        ...
        np.save(os.path.join('./vis/rgb',str(batch_idx)+'.npy'), batch_data)
