...
def batch_norm_template_unused(inputs, is_training, scope, moments_dims, bn_decay,data_format='NHWC'):
...
def batch_norm_for_fc(inputs, is_training, bn_decay, scope):
  ...
  Return:
      normed:      batch-normalized maps
  """
  return batch_norm_template_unused(inputs, is_training, scope, [0,], bn_decay)
...
def batch_norm_for_conv1d(inputs, is_training, bn_decay, scope, data_format):
  ...
  Return:
      normed:      batch-normalized maps
  """
  return batch_norm_template_unused(inputs, is_training, scope, [0,1], bn_decay, data_format)
...
def batch_norm_for_conv2d(inputs, is_training, bn_decay, scope, data_format):
  ...
  Return:
      normed:      batch-normalized maps
  """
  return batch_norm_template_unused(inputs, is_training, scope, [0,1,2], bn_decay, data_format)
...
def batch_norm_for_conv3d(inputs, is_training, bn_decay, scope):
  ...
  Return:
      normed:      batch-normalized maps
  """
  return batch_norm_template_unused(inputs, is_training, scope, [0,1,2,3], bn_decay)
